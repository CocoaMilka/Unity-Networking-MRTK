...
namespace Unity.BossRoom.ConnectionManagement
{
    ...
    class HostingState : OnlineState
    {
        ...
        public override void Enter()
        {
            ...
            //SceneWrapper.Instance.LoadScene("InteractiveScene", useNetworkSceneManager: true);
//#if UNITY_STANDALONE
//            SceneWrapper.Instance.LoadScene("InteractiveSceneGoPro", useNetworkSceneManager: true);
//            //SceneWrapper.Instance.LoadScene("InteractiveSceneHololens", useNetworkSceneManager: true);
//#elif UNITY_EDITOR
//            SceneWrapper.Instance.LoadScene("InteractiveSceneGoPro", useNetworkSceneManager: true);
//#else
//            //SceneWrapper.Instance.LoadScene("InteractiveSceneHololens", useNetworkSceneManager: true);  
//            SceneWrapper.Instance.LoadScene("InteractiveSceneHololens1", useNetworkSceneManager: true);    
//#endif
            SceneWrapper.Instance.LoadScene("InteractiveSceneAll", useNetworkSceneManager: true);
