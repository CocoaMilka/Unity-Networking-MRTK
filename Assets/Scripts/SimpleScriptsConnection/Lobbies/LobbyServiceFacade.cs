...
namespace Unity.BossRoom.UnityServices.Lobbies
{
    ...
    /// </summary>
    public class LobbyServiceFacade : MonoBehaviour, IDisposable /*, IStartable*/
    {
        //[Inject] LifetimeScope m_ParentScope;
        //[Inject] UpdateRunner m_UpdateRunner;
        /*[Inject]*/ LocalLobby m_LocalLobby => AppController.Instance.LocalLobby;
        /*[Inject]*/ LocalLobbyUser m_LocalUser => AppController.Instance.LocalLobbyUser;
        ...
        IPublisher<LobbyListFetchedMessage> m_LobbyListFetchedPub => AppController.Instance.PublishLobbyListFetchedMessage;
        ...
        LobbyAPIInterface m_LobbyApiInterface => AppController.Instance.LobbyAPIInterface;
        ...
        public async Task RetrieveAndPublishLobbyListAsync()
        {
            ...
            try
            {
                ...
                LobbyJoiningUI.Instance?.UpdateUIDirect(new LobbyListFetchedMessage(LocalLobby.CreateLocalLobbies(response)));
